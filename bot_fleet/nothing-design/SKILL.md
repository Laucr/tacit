...
name: Nothing design
description: >-
  Use this when the user explicitly says "Nothing style", "Nothing design",
  "/nothing-design", or asks to apply the Nothing design system. Never trigger
  automatically for generic UI or design tasks.
---
...
Source: https://github.com/dominikmartn/nothing-design-skill (MIT). Companion `references/` files are installed next to this skill — Read them before designing.
