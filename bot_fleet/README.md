...
This pack is **nested on purpose** so it does not collide with tacit's one-skill-per-top-level Claude Code loader convention. Personal / finance-preference skills live in the private [Laucr/bot-fleet](https://github.com/Laucr/bot-fleet) repo instead. Third-party packs (e.g. Nothing design) stay upstream.
